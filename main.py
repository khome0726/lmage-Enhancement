...
parser.add_argument('--test_dir', dest='test_dir', default='./data/test/low_8bit', help='directory for testing inputs')
...
def lowlight_train(lowlight_enhance):
    ...
    train_low_data_names =glob(r'D:/Code/conda_env\DATABASE/485_low/GRAY_8bit/*.png')+glob(r'D:\Code\conda_env\DATABASE\BrighteningTrain\BrighteningTrain/gray/low/*.png')+glob(r'D:/Code/conda_env\DATABASE/prof.f/gray/low/*.png')
    train_low_data_names.sort()
    train_high_data_names =glob(r'D:/Code/conda_env\DATABASE/485_high/GRAY_8bit/*.png')+glob(r'D:\Code\conda_env\DATABASE\BrighteningTrain\BrighteningTrain/gray/high/*.png')+glob(r'D:/Code/conda_env\DATABASE/prof.f/gray/high/*.png')
...
def main(_):
    ...
    for variable in tf.trainable_variables():
        ...
        print(f"Layer: {variable.name} , Shape: {variable.get_shape()}")
